...
export default function initApp () {
    ...
    L.Control.Search = L.Control.extend({
      ...
      this.challengeWrapper1  = L.DomUtil.create('span', 'challenge__icon challenge__1', this.challengeWrapper  );
      this.challengeWrapper2  = L.DomUtil.create('span', 'challenge__icon challenge__2', this.challengeWrapper  );
      this.challengeWrapper3  = L.DomUtil.create('span', 'challenge__icon challenge__3', this.challengeWrapper  );
      this.challengeWrapper4  = L.DomUtil.create('span', 'challenge__icon challenge__4', this.challengeWrapper  );
      this.challengeWrapper5  = L.DomUtil.create('span', 'challenge__icon challenge__5', this.challengeWrapper  );
